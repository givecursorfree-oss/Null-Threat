...
const csp = [
  ...
  "img-src 'self' data: blob: https://assets.unicorn.studio https://assets.watermelon.sh https://hoirqrkdgbmvpwutwuwj.supabase.co https://framerusercontent.com",
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      framer: fileURLToPath(new URL("./src/framer/framer-stub.tsx", import.meta.url)),
    },
  },
  server: {
    port: 3000,
